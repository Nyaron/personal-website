<template>
  <div id="contact">
    <p>{{ $t("contact.text1") }} <a href="#" role="button" @click.prevent="scrollTo('page-4')">{{ $t("contact.text2") }}</a>. {{ $t("contact.text3") }}</p>
    <div class="wrap">
      <div class="clip-row">
        <div class="clip-block">
          <div class="clip-each clip-gradient lnk-email" @click="scrollTo('page-4')">
